...
def run_ai_client(project_slug: str, user_id: int, model: str, scenario_id: int, user_input: str = ""):
    try:
        ...
        return client.run(project_slug, user_input=user_input, scenarios=full_path)

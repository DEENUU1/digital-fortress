...
@shared_task()
def run_ai_client_task(project_slug, user_id: int, model: str, scenario_id: int, user_input: str = "") -> None:
    response = run_ai_client(project_slug, user_id, model, scenario_id, user_input)
